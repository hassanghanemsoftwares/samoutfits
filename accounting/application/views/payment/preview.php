        ...
        <div class="col-sm-12" style="border-bottom: 1px solid #808080; padding:10px;">
            ...
            <div class="col-sm-3 col-sm-offset-4">
                <p style="color: #3e4b51; text-align:left;">
                    <b><?php echo $this->lang->line('Print') ?><?php echo $this->lang->line('Company_Name') ?>:</b> <?php echo $company_name ?>
                    <br>
                    <b><?php echo $this->lang->line('Print') ?><?php echo $this->lang->line('Phone') ?>: </b> <?php echo $company_phone ?>
                    <br>
                    <b><?php echo $this->lang->line('Print') ?><?php echo $this->lang->line('Address') ?>: </b> <?php echo $company_address ?>
                    <br>
                    <b><?php echo $this->lang->line('Print') ?><?php echo $this->lang->line('Email') ?>: </b><?php echo $company_email ?>
                    <br>
                    <b><?php echo $this->lang->line('Print') ?><?php echo $this->lang->line('Website') ?>: </b><?php echo $company_website ?>
                </p>
            </div>
        </div>
        <div class="col-sm-12" style="margin-top: 30px; margin-bottom: 30px;">
            <div class="col-sm-2">
                <p style="text-align: left; color: #e84c3c;"><b><?php echo $this->lang->line('Account_from_Info') ?>: </b></p>
            </div>
            <div class="col-sm-3 ">
            ...
            <div class="col-sm-2 col-sm-offset-2">
                <p style="text-align: left; color: #e84c3c;"><b><?php echo $this->lang->line('Account_to_Info') ?>: </b></p>
            </div>
            <div class="col-sm-3 ">
                <p style="text-align: left; color: #3e4b51;">
        ...
        <div class="col-sm-4 col-sm-offset-4" style="border: 1px solid #808080; padding: 10px; border-radius: 10px;">
            <div class="col-sm-6">
                <p style="color: #3e4b51">
                    <b><?php echo $this->lang->line('Payment_Number') ?>: </b>
                </p>
            </div>
            <div class="col-sm-6">
                <p style="color: #3e4b51;">
            ...
            <div class="col-sm-6">
                <p style="color: #3e4b51">
                    <b><?php echo $this->lang->line('Payment_Date') ?>: </b>
                </p>
            </div>
            <div class="col-sm-6">
                <p style="color: #3e4b51;">
            ...
            <div class="col-sm-6">
                <p style="color: #e84c3c;">
                    <b><?php echo $this->lang->line('Payment_Amount') ?>: </b>
                </p>
            </div>
            <div class="col-sm-6">
                <p style="color: #3e4b51;">

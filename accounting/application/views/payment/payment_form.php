<p class="text-right">
	<?php echo anchor('payments/preview/' . $this->Journal->get_field('id'), $this->lang->line('Print'), 'accesskey="p" class="btn btn-primary"  id="print"') ?>
	<?php echo anchor('payments/index', $this->lang->line('Back'), 'accesskey="b" class="btn btn-primary" id="bgback"') ?>
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="auto_no"><?php echo $this->lang->line('Payment') ?> #</label>
			<div class="col-sm-8">
				<?php
	...
	<div class="col-sm-8">
		<div class="form-group">
			...
			<div class="col-sm-9">
				<?php
				echo form_input('trans[amount]', $this->Journal->get_field('amount'), 'id="amount" class="form-control" style="border-color:grey;" autocomplete="off" required'),
				$this->Journal->get_error('currency_rate')
				?>

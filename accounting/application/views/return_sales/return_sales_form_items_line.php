<tr id="<?php echo 'item-%d' ?>" data-index="<?php echo '%d' ?>">
    ...
    <td><?php echo form_dropdown('transItems[%d][warehouses]', $warehouses_list, '',  'id="warehouses" class="form-control i-warehouse" type="input"')
        ?></td>
    ...
    <td><?php echo form_dropdown('transItems[%d][sizes]', $sizes, '', 'id="sizes" class="form-control i-sizes" style="width: 100px;"')
        ?></td>
    <td><input name="transItems[%d][qty]" type="text" class="form-control i-qty" /></td>

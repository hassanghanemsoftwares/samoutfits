<p class="text-right">
	<?php echo anchor('delivery_notes/preview/' . $this->Transaction->get_field('id'), 'Delivery Note', 'accesskey="b" class="btn btn-primary hide" id="bgadd"') ?> &nbsp;&nbsp;
	<button onclick="AddAccount()" class="btn btn-primary hide" id="bgadd"><?php echo $this->lang->line('Account') ?></button>
	<?php echo anchor('orders/index', $this->lang->line('Back'), 'accesskey="b" class="btn btn-primary" id="bgback"') ?>
</p>
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="auto_no"><?php echo $this->lang->line('Sale') ?> #</label>
			<div class="col-sm-8">
				<?php
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<?php
				echo form_dropdown('trans[currency_id]', $currenciesList, $this->Transaction->get_field('currency_id'), 'id="currency_id" class="form-control"'),
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<?php echo form_input('trans[trans_date]', date('d-m-Y'), 'id="trans_date" class="form-control" required'), $this->Transaction->get_error('trans_date')
				?>
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<?php echo form_input('trans[value_date]', $this->Transaction->get_field('value_date'), 'id="value_date" class="form-control"'), $this->Transaction->get_error('value_date')
				?>
	...
	<div class="col-sm-12 text-right">
		<div class="col-sm-3">
			<div class="form-group">
				...
				<div class="col-sm-6">
					<?php
					echo form_input('trans[sub_total]', '', 'id="sub_total" class="form-control"')
					?>
				</div>
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<div class="col-sm-6">
					<?php
					echo form_input('trans[final_total]', '', 'id="final_total" class="form-control"')
					?>
				</div>
			</div>
		</div>

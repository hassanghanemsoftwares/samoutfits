...
<div class="col-sm-3">
	...
	?>
		<label class="col-sm-4 control-label" for="stock_cost"><?php echo $this->lang->line('Stock_Cost'); ?></label>
		<div class="col-sm-8">
			<input type="text" value="<?php echo number_format((float)$stock_cost, 2, '.', '')  ?>" name="stock_cost" id="stock_cost" class="form-control" readonly>
		</div>
	<?php
	} ?>
</div>
...
<div class="col-sm-9">
	...
	<div class="col-sm-2">
		<div class="form-group">
			<?php echo form_submit('filter', 'Filter', 'id="filter" class="btn btn-primary btnfilter"') ?>
		</div>
	</div>
	<?php echo form_close() ?>
</div>
	...
	<table style="width:100%;" class="table table-bordered table-striped table-hover table-condensed table-responsive" id="itemsTbl" data-num-rows="<?php echo $this->Item->get('paginationTotalRows') ?>">
		<thead>
			<tr>
				...
				<th><?php echo $this->lang->line('cost_lc') ?></th>
				<th><?php echo $this->lang->line('purchase_cost') ?></th>
				...
				<th><?php echo $this->lang->line('published') ?></th>
			...
			<div class="modal-body">
				...
				<div class="col-sm-12 form-group">
					...
					<div class="col-sm-6 mt-2">
						<div class="form-group">
							<input class="col-sm-1" type="checkbox" id="edit_variant1" name="edit_variant1" value="1">
							<label class="col-sm-2 control-label" for="edit_variant1"><?php echo $this->lang->line('variant1'); ?></label>
							<div class="col-sm-9">
								<?php
								echo form_dropdown('variant1', $variant1, '', 'id="variant1" class="form-control"')
								?>
							</div>
						</div>
					</div>

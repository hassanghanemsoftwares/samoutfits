...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<?php
				echo form_dropdown('currency_id_list', $currenciesList, $trans['currency_id'], 'id="currency_id_list" class="form-control"'),
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<?php
				echo form_input('trans[currency_rate]', $trans['currency_rate'], 'id="currency_rate" class="form-control" required'),

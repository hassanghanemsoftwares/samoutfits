<p class="text-right">
	...
	<?php echo anchor('orders/preview/' . $this->Transaction->get_field('id'), $this->lang->line('Print'), 'accesskey="p" class="btn btn-primary"  id="print"') ?>
</p>
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="auto_no"><?php echo $this->lang->line('Order') ?> #</label>
			<div class="col-sm-8">
				<?php
	...
	<div class="col-sm-12 table-responsive">
		<table class="table table-bordered table-condensed table-striped table-hover">
			...
			<tbody id="transactionLines">
				<?php
				$this->load->view('orders/edit_order_form_items_line', ['transItems' => isset($trans_items) ? $trans_items : []]);
				?>
			</tbody>
		</table>
...
<script type="text/javascript">
	const ItemLineTpl = <?php echo json_encode($this->load->view('orders/order_form_items_line', [], true)) ?>;
</script>
<!-- Account Form Modal -->
<?php

<tr id="<?php echo 'item-%d' ?>" data-index="<?php echo '%d' ?>">
    ...
    <td><?php echo form_dropdown('transItems[%d][warehouses]', $warehouses_list, (isset($warehouses_list['Primary Warehouse']))? 'Primary Warehouse' : '',  'id="warehouses" class="form-control i-warehouse" type="input" style="width: 100px;"')
        ?></td>
    ...
    <td><input name="transItems[%d][price]" id="price" type="text" class="form-control i-price" style="width: 70px;"/></td>
    <td><input name="transItems[%d][cost]" id="cost" type="text" class="form-control i-cost" style="width: 70px;"/></td>
    <td><input name="transItems[%d][discount]" id="discount" type="text" class="form-control i-discount" style="width: 70px;"/></td>

...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="auto_no">OP #</label>
			<div class="col-sm-8">
				<?php
		...
		<table id="table-fixed" class="table table-bordered table-condensed table-striped table-hover">
			<thead>
				<tr class="form_table_head">
					...
					<th class="col-sm-1"><?php echo $this->lang->line('Description') ?></th>
					<th class="col-sm-1"><?php echo $this->lang->line('Barcode') ?></th>
					<th class="col-sm-2"><?php echo $this->lang->line('Warehouse') ?></th>
					<th class="col-sm-2"><?php echo $this->lang->line('Shelf') ?></th>
					<th class="col-sm-2"><?php echo $this->lang->line('Qty') ?></th>
					<?php if ($sizes[0] !== '') {
						foreach ($sizes as $s) { ?>
							<th><?php echo $s ?></th>
					<?php }
					...
					<th class="col-sm-1"><?php echo $this->lang->line('Unit_Cost') ?></th>
					<th class="col-sm-1"><?php echo $this->lang->line('Extra_Cost') ?></th>
					<th class="col-sm-1"><?php echo $this->lang->line('Discount') ?></th>
					<th class="col-sm-1 text-center"><?php echo $this->lang->line('Net_Cost') ?></th>
					<th class="col-sm-1 text-right"><?php echo $this->lang->line('Total') ?></th>
				</tr>
			</thead>

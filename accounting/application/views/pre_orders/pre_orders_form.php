...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<?php
				echo form_dropdown('trans[status2]', $status2, $selected_status2, 'id="status2" class="form-control"')
				?>
			</div>
		</div>
	</div>
	...
	<div class="col-sm-12 table-responsive">
		<table class="table table-bordered table-condensed table-striped table-hover">
			...
			<tbody id="transactionLines">
				<?php
				$this->load->view('pre_orders/edit_pre_orders_form_items_line', ['transItems' => isset($trans_items) ? $trans_items : []]);
				?>
			</tbody>
		</table>
	...
	<table class="table table-bordered table-condensed table-striped table-hover">
		<thead>
			<tr style="background-color: #333; color:white">
				<th colspan="3" style="text-align: center;"><?php echo $this->lang->line('Product_Availability_in_Order_Purchase') ?> </th>
			</tr>
			<tr class="form_table_head">
				<th><?php echo $this->lang->line('Barcode') ?></th>
...
<div class="col-sm-6 table-responsive">
	<table class="table table-bordered table-condensed table-striped table-hover">
		<thead>
			<tr style="background-color: #333; color:white">
				<th colspan="3" style="text-align: center;"><?php echo $this->lang->line('Product_Pre_Orders') ?> </th>
			</tr>
			<tr class="form_table_head">
				<th><?php echo $this->lang->line('Barcode') ?></th>
				<th><?php echo $this->lang->line('Size') ?></th>
		...
		<tbody id="os_qty_tbody">

		</tbody>
	</table>
</div>
<script type="text/javascript">
	const ItemLineTpl = <?php echo json_encode($this->load->view('pre_orders/pre_orders_form_items_line', [], true)) ?>;
</script>
<!-- Account Form Modal -->
<?php

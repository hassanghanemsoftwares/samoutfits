...
<div class="row">
	...
	<div class="col-sm-4">
		<p class="text-right">
			<button type="button" name="reset_filters" id="reset_filters1" class="btn bt-link btn-s btn-small-design"><i class="glyphicon glyphicon-refresh"></i></button>
			<button type="button" id="bulk" class="btn btn-primary btnbulk"><?php echo $this->lang->line('Bulk_Actions') ?></button>
			<a href="pre_orders/add" class="btn btn-primary"><?php echo $this->lang->line('Add_Pre_order') ?></a>
		</p>
	</div>
</div>
<div class="row">
...
<table class="table table-bordered table-striped table-hover table-condensed table-responsive" id="preordersTbl" data-num-rows="<?php echo $this->Transaction->get('paginationTotalRows') ?>">
	<thead>
		<tr>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<!-- <div>
					<div class="col-sm-12">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="col-sm-4 control-label" for="driver">Delivery</label>
								<div class="col-sm-8">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="col-sm-4 control-label" for="value_date">Dispatch Date</label>
								<div class="col-sm-8">
					...
					<div class="col-sm-12">
						<div class="col-sm-4">
							<div class="form-group">
								<label class="col-sm-4 control-label" for="receipt">Receipts</label>
								<div class="col-sm-8">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="col-sm-4 control-label" for="cash_date">Cash Date</label>
								<div class="col-sm-8">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="col-sm-4 control-label" for="return_date">Return Date</label>
								<div class="col-sm-8">
			...
			<div class="modal-footer">
				<div class="col-sm-12">
					...
					<?php echo form_open('pre_orders/check_pre_order_transfer', 'id="BulkPrintForm" name="BulkPrintForm" role="form" autocomplete="off" novalidate') ?>
					<div class="col-sm-3 col-sm-offset-1">
						<input type="text" name="all_ids" id="all_ids" hidden>
						<button type="submit" class="btn btn-primary hide" id="bulk_print" onclick='this.form.action="sales/bulk_preview";'><?php echo $this->lang->line('Print_All_Private') ?></button>
					</div>
					<div class="col-sm-3">
						<button type="submit" class="btn btn-primary hide" id="bulk_wakilni_print" onclick='this.form.action="sales/bulk_wakilni_preview";'><?php echo $this->lang->line('Print_All_Wakilni') ?></button>
					</div>
					<div class="col-sm-3">

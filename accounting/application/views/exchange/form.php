...
<p class="text-right">
	...
	<?php echo anchor('sales/wakilni_preview/' . $this->Transaction->get_field('id'), $this->lang->line('Print_wakilni'), 'accesskey="p" class="btn btn-primary"  id="wakilni_print"') ?>
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<div class="col-sm-8">
				<?php
				echo form_input('trans[auto_no]', $auto_no, 'id="auto_no" class="form-control" readonly="true" required '),
	...
	<div class="col-sm-4">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<?php echo form_textarea('trans[delivery_note]', $DN, 'id="delivery_note" class="form-control" style="height:100px;"') ?>
			</div>
		</div>
	</div>
	<div class="col-sm-12 table-responsive">
		<table class="table table-bordered table-condensed table-striped table-hover">
			...
			<tbody id="transactionLines">
				<?php
				$this->load->view('exchange/edit_form_items_line', ['transItems' => isset($trans_items) ? $trans_items : []]);
				?>
			</tbody>
		</table>
	...
	<div class="col-sm-12">
		<div class="col-sm-3">
			<div class="form-group">
				<label class="col-sm-4 control-label" for="sub_total"><?php echo $this->lang->line('Subtotal') ?></label>
				<div class="col-sm-8">
					<?php
		...
		<div class="col-sm-3">
			<div class="form-group">
				<label class="col-sm-4 control-label" for="sub_total"><?php echo $this->lang->line('Old_Subtotal') ?></label>
				<div class="col-sm-8">
					<?php
					echo form_input('trans[old_sub_total]', $old_sub_total, 'id="old_sub_total" class="form-control"')
					?>
					<div id="error_old_sub_total" style="text-align:center" onclick="document.getElementById('error_old_sub_total').style.display = 'none'"></div>
				</div>
			</div>
		</div>
		<div class="col-sm-3">
			<div class="form-group">
				<label class="col-sm-4 control-label" for="discount"><?php echo $this->lang->line('Discount') ?></label>
				<div class="col-sm-8">
					<?php
		...
		<div class="col-sm-3">
			<div class="form-group">
				<label class="col-sm-4 control-label" for="delivery_charge"><?php echo $this->lang->line('delivery_charge') ?></label>
				<div class="col-sm-8">
					<?php
...
<script type="text/javascript">
	const ItemLineTpl = <?php echo json_encode($this->load->view('exchange/form_items_line', [], true)) ?>;
</script>
<!-- Account Form Modal -->
<?php

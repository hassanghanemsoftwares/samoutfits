<p class="text-right">
	...
	<?php echo anchor('return_purchases/preview/' . $this->Transaction->get_field('id'), $this->lang->line('Print'), 'accesskey="p" class="btn btn-primary"  id="print"') ?>
</p>
...
<div class="row">
	...
	<div class="col-sm-4">
		<div class="form-group">
			<label class="col-sm-4 control-label" for="auto_no"><?php echo $this->lang->line('Return_Purchase') ?> #</label>
			<div class="col-sm-8">
				<?php

<p class="text-right">
<?php echo anchor('return_purchases/add', $this->lang->line('Add_Return_Purchase'), 'accesskey="a" class="btn btn-primary" id="bgadd" style="width:210px;"') ?>
</p>
<div class="col-sm-12">
	<div class="col-sm-4">
...
<table class="table table-bordered table-striped table-hover table-condensed table-responsive" id="returnpurchasesTbl" data-num-rows="<?php echo $this->Transaction->get('paginationTotalRows') ?>">
	<thead>
		<tr>

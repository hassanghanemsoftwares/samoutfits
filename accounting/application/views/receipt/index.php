<p class="text-right">
<?php echo anchor('receipts/add', 'Add Receipts', 'accesskey="a" class="btn btn-primary" id="bgadd"') ?>
</p>
<div class="col-sm-12">
	<div class="col-sm-4">
...
<table class="table table-bordered table-striped table-hover table-condensed table-responsive" id="receiptsTbl" data-num-rows="<?php echo $this->Journal->get('paginationTotalRows') ?>">
	<thead>
		<tr>

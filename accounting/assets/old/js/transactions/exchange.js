...
function validation() {
	...
	if (old_sub_total.trim() == "") {
		document.getElementById('error_old_sub_total').innerHTML = "*please enter number for Old Subtot*";
		document.getElementById('error_old_sub_total').className = "alert alert-danger";
		count++;
	}
	if (isNaN(old_sub_total) == true) {
		document.getElementById('error_old_sub_total').innerHTML = "*Old Subtot must be numeric*";
		document.getElementById('error_old_sub_total').className = "alert alert-danger";
		count++;
	}
	if (count > 0) {

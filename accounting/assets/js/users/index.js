jQuery(document).ready(function () {
    ...
    let dtActionsHTML = '<a href="' + getAppURL('users/edit/') + '%d" class="btn bt-link btn-xs" title="Edit"><i style="color:#282828;"  class="glyphicon glyphicon-pencil"></i></a>' +
            ...
            '<i class="glyphicon glyphicon-trash text-danger"></i></a>'+'<a href="' + getAppURL('users/edit_permissions/') + '%d"class="btn bt-link btn-xs" title="Permissions">' +
            '<i class="glyphicon glyphicon-lock text-primary"></i></a>';
    /***************************************************/
    var $dtTbl = $('#usersTbl');

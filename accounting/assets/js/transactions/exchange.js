...
function validation() {
  ...
  if (
    ...
    getAppURL("sales/exchange/".concat(url_array[url_array.length - 1]))
  ) {
    $trans_id = "";
  } else {
    $trans_id = $("#id").val();
  ...
  if (
    ...
    document.getElementById("error_acctLkupTo").innerHTML =
  ...
  if (
    ...
    document.getElementById("error_acctLkupFrom").innerHTML =
      "*Please select a Purchases Account*";
  ...
  if (old_sub_total.trim() == "") {
    document.getElementById("error_old_sub_total").innerHTML =
      _lang.field_required;
    document.getElementById("error_old_sub_total").className =
      "alert alert-danger";
    count++;
  }

$(document).ready(function () {
    if (window.location.href == getAppURL('accounts/add')) {
        ...
        $("#country_phone").attr("data-default", $("#country").val())
        $('#country_phone').countrypicker('setCountry', $("#country").val());
        $("#country_phone2").attr("data-default", $("#country").val())
        $('#country_phone2').countrypicker('setCountry', $("#country").val());
...
function validation() {
    ...
    if ($('#phone').val().trim() == "") {
        ...
        if (Array.isArray(lenthofcountry)) {
            ...
            coutcountry = 1
            if ($('#phone').val().length == lenthofcountry) {
                coutcountry = 0
            }
        }
        ...
        if (coutcountry != 0) {
            ...
            var exitstphone = 0;
            if (remove_all_after_last_slash(window.location.href) == getAppURL('accounts/edit')) {
                $.ajax({
                    cache: false,
                    type: 'POST',
                    async: false,
    ...
    if ($('#phone2').val().trim() != "") {
        ...
        if (Array.isArray(lenthofcountry)) {
            ...
            coutcountry2 = 1
            if ($('#phone2').val().length == lenthofcountry2) {
                coutcountry2 = 0
            }
        }
        if (coutcountry2 != 0) {
...
function remove_all_after_last_slash(string) {
...
if (remove_all_after_last_slash(window.location.href) == getAppURL('accounts/edit')) {
    ...
    if (Array.isArray(getCountryCode(phoneNumber))) {
        ...
        $("#country_phone").attr("data-default", countryName)
        $('#country_phone').countrypicker('setCountry', countryName);

    } else {
        $("#country_phone").attr("data-default", "LB")
        $('#country_phone').countrypicker('setCountry', "LB");
    }

    if ($("#phone2").val() == "") {
        $("#country_phone2").attr("data-default", "LB")
        $('#country_phone2').countrypicker('setCountry', "LB");
    } else {
        ...
        $("#country_phone2").attr("data-default", countryName2)
        $('#country_phone2').countrypicker('setCountry', countryName2);
...
//     "Alman Chouf",
//     "Arbet Kozhaya",
//     "Bakifa ( Rachaya - West Bekaa )",
//     "Britel",
//     "Fraydiss ( Hasbaya - Nabatiyeh )",
//     "Btormaz",
//     "Ainatha",
//     "Batoulay",
//     "Berkayel",
...
//     "Tiri",
//     "Arzay",
//     "kaki3iyet l sanawbar",
//     "Ansar(baalback)",
//     "Akbieh (saida)",
//     "Bazbina",
//     "Wakilni Tripoli Office (Self Pickup)",
//     "Wakilni Sarafand  Office (Self Pickup)",
//     "Ajaltoun (Metn)",
//     "Hellaniyeh",
//     "Beit El Faks",
//     "Khreybeh (Metn)",

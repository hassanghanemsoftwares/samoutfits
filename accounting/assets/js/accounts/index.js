jQuery(document).ready(function () {
	...
	let dtActionsHTML = '<a href="' + getAppURL('accounts/edit/') + '%d" class="btn bt-link btn-xs" title="Edit"><i style="color:#282828;" class="glyphicon glyphicon-pencil"></i></a>' +
		'<a href="javascript:void(0);" onclick="confirmDelete(\'' + getAppURL('accounts/delete/') + '%d\')"class="btn bt-link btn-xs" title="Delete">' + '<i class="glyphicon glyphicon-trash text-danger"></i></a>' +
		'<a href="' + getAppURL('accounts/open_customer_whatsapp/') + '%d" class="btn bt-link btn-xs" target="_blank" title="Whatsapp"><img src="assets/images/whatsapp.png" width="20" height="20"></a>' +
		 '<a href="' + getAppURL('accounts/activity/') + '%d" class="btn bt-link btn-xs" title="Activity"><i class="glyphicon glyphicon-info-sign text-danger"></i></a>';

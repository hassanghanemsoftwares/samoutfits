...
function validation() {
    ...
    if (warehouses.length !== uniqueSet.size) {
        document.getElementById('error_transactionLines').innerHTML =  _lang.duplicate_entry;
        document.getElementById('error_transactionLines').className = "alert alert-danger";
        count++;
    }
    if (document.transactionForm.trans_date.value == "") {
        document.getElementById('error_trans_date').innerHTML = _lang.field_required;
    ...
    if (document.getElementById('transactionLines').rows.length == "0") {
        document.getElementById('error_transactionLines').innerHTML = _lang.field_required;
        document.getElementById('error_transactionLines').className = "alert alert-danger";
        count++;
    }
    if (count > 0) {

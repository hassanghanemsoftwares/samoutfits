       ...
       <div class="row px-xl-5">
           ...
           <div class="col-lg-3 col-md-4 hide-filter-on-mobile" id="filter_div">
               ...
               <div class="bg-light p-4 mb-30">
                   <input type="text" id="url_link" value="<?php echo 'products/stock_clearance'; ?>" hidden>
                   <div>
                       <center>
                           <section class="range-slider">
                               ...
                               <input name="rangeOne" id="minpr" value="<?php echo $min_price ?>" min="0" max="<?php echo $price_max ?>" step="1" type="range">
                               <input name="rangeTwo" id="maxpr" value="<?php echo $max_price ?>" min="0" max="<?php echo $price_max ?>" step="1" type="range">
                           </section>
                       </center>
                   </div>
               </div>
               ...
               <div class="bg-light p-4 mb-30" hidden>
                   ...
                   <?php foreach ($sub_categories as $c) { ?>
                       <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                           <input type="checkbox" class="custom-control-input sub_category" name="sub_category" id="sub_category-<?php echo $c ?>" value="<?php echo $c ?>" <?php echo (array_key_exists(str_replace(' ', '%20', $c), $selected_subcategory)) ? 'checked' : ''; ?>>
               ...
               <div class="bg-light p-4 mb-30">
                   ...
                   <?php foreach ($colors_list as $color) { ?>
                       <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                           <input type="checkbox" class="custom-control-input color" name="color" id="color-<?php echo $color ?>" value="<?php echo $color ?>" <?php echo (in_array($color, str_replace('%20', ' ', str_replace('%and', '&', $colors)))) ? 'checked' : ''; ?>>
                           ...
                           <div class="product-item bg-light mb-4">
                               <div class="product-img position-relative overflow-hidden">
                                   <a href="<?php echo 'products/view/' . $n['id'] ?>">
                                       <img class="w-100 <?php echo ($n['total_qty'] > 0) ? '' : 'image_blur' ?>" src="<?php echo 'accounting/assets/uploads/' . $n['image_name'] ?>" height="180px">
                                   </a>

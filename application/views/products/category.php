    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-3 col-md-4 hide-filter-on-mobile" id="filter_div">
            ...
            <div class="bg-light p-4 mb-30">
                <input type="hidden" id="url_link" value="<?php echo base_url(($category_name == 'Bags & Wallets') ? 'products/category/Wallets' : "products/category/" . str_replace("&", "-and", str_replace(' ', '_',$category_name))); ?>">
                <div>
                    <center>
            ...
            <div class="bg-light p-4 mb-30" hidden>
                ...
                <?php foreach ($sub_categories as $c) { ?>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input sub_category" name="sub_category" id="sub_category-<?php echo $c ?>" value="<?php echo str_replace('&', '-and', str_replace(' ', '_', $c)) ?>" <?php echo (array_key_exists(str_replace('&', '-and', str_replace(' ', '_', $c)), $selected_subcategory)) ? 'checked' : ''; ?>>
                        <label class="custom-control-label" for="sub_category-<?php echo $c ?>"><?php echo $c ?></label>
                        <span class="badge border font-weight-normal"><?php // var_dump($selected_subcategory, str_replace('&', '-and', str_replace(' ', '_', $c))) ?></span>
                    </div>
                <?php } ?>
            </div>
            <!-- Subcat End -->
            ...
            <div class="bg-light p-4 mb-30" <?php echo ($gender) ? "" : "hidden"; ?>>
                ...
                <?php foreach ($gender as $c) { ?>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input gender" name="gender" id="gender-<?php echo $c ?>" value="<?php echo $c ?>" <?php echo (array_key_exists(str_replace(' ', '_', $c), $selected_gender)) ? 'checked' : ''; ?>>
            ...
            <div class="bg-light p-4 mb-30">
                ...
                <?php foreach ($colors_list as $color) { ?>
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        <input type="checkbox" class="custom-control-input color" name="color" id="color-<?php echo $color ?>" value="<?php echo str_replace('&', '-and', str_replace(' ', '_', $color)) ?>" <?php echo (in_array($color, str_replace('_', ' ', str_replace('-and', '&', $colors)))) ? 'checked' : ''; ?>>
            ...
            <div class="bg-light p-4 mb-30" <?php echo ($hide_size == 0) ? '' : 'hidden'; ?>>
                <form>
                    ...
                    <?php foreach ($sizes_list as $size) { ?>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input sizes" id="size-<?php echo $size ?>" value="<?php echo $size ?>" <?php echo (array_key_exists(str_replace(' ', '_', $size), $sizes)) ? 'checked' : ''; ?>>

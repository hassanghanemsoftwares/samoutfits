jQuery(document).ready(function () {
  ...
  $("#password, #confirm_password").on("keyup", function () {
    ...
    if ($("#password").val() !== "" && $("#confirm_password").val() !== "") {
      if ($("#password").val() == $("#confirm_password").val()) {
        $("#msg_password")
          .html('<i class="fa fa-check"></i> ' + _lang.Password_Matching)
          .css("color", "green");
        // $count = 0;
      } else {
        $("#msg_password")
          .html(
            '<i class="fa fa-exclamation"></i> ' + _lang.Password_Not_Matching
          )
          .css("color", "red");
        // $count = 1;
      }
  ...
  $("#phone").on("keyup", function (event) {
    ...
    if ($("#phone").val().match(phonenb)) {
      ...
      $("#msg_phone")
        .html('<i class="fa fa-exclamation"></i> ' + _lang.Wrong_Format)
        .css("color", "red");
      // $count = 1;
    }
    //2024-03-20 changes
...
function validation() {
  ...
  if ($("#phone").val() == "") {
    ...
    if (coutcountry != 0) {
      count = 6;
      $("#msg_phone")
        .text("Please check phone number length")
        .css("color", "red");
    } else {
      $("#msg_phone").text("");
    }
  ...
  if ($("#phone2").val() != "") {
    var coutcountry2 = 0;
    var phone2_code = $("#phone2_code").val().replace("+", "");

    var lenthofcountry2 = getPhoneLengthByCountryCode(phone2_code);
    console.log(lenthofcountry2);

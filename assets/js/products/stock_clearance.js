jQuery(document).ready(function () {
    $('#minpr, #maxpr, .color, .sizes, .gender').on('change', function (e) {
...
function create_url_link_and_redirect(page) {
    ...
    $('.color').each(function () {
        if (this.checked == true) {
            let color_rep = this.value.replace("&", "%and");
    ...
    window.location.href = base_link + "/" + price_range + "/" + color_filter + "/" + sizes_filter + "/" + gender_filter + "/" + page;
}
